<?php
/**
 * Template Name: Template page "Thanks page"
 */
?>
<?php get_header(); ?>
<!-- Content -->
        ...
        <div class="wrapper">
            <div class="notfound-banner-parent">
                <div class="thanks-text">
                    <?php echo $header_group['title'];?>
                    <a href="<?php echo $header_group['button']['url'];?>"><?php echo $header_group['button']['title'];?></a>
                </div>
                <div class="notfound-img">
                    <img src="<?php echo $header_group['image'];?>" alt="thanks">
                </div>
            </div>
        </div>
    </div>
